...
def main(fit=True, plot=False):
    ...
    individuals = [ind.lesion_SHAM() for ind in individuals if ind['fitness_history'][-1][1] > reject_threshold]
    ...
    if plot:
        ...
        figure.savefig(os.path.join(POPULATION_BASE_PATH, 'sensitivity_analysis_matrix.png'), dpi=FIG_DPI,
                       bbox_inches='tight')
